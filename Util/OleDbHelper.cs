    ...
    public class OleDbHelper
    {
        ...
        public static OleDbConnection GetOleDbConnection()
        {
            ...
            return new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source="
                + strDPath.Substring(0, strDPath.LastIndexOf("\\")).Substring(0, strDPath.Substring(0, strDPath.LastIndexOf("\\")).LastIndexOf("\\")) + "\\MyDB.mdb");
        }
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        public static DataSet ExecuteDatasetFill(string cmdText, string fill, params object[] p)
        {
            DataSet ds = new DataSet();
            OleDbCommand command = new OleDbCommand();
            using (OleDbConnection connection = GetOleDbConnection())
